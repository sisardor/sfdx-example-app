  ...
  */
  ...
  PDFTron.WebViewer.prototype = {
    ...
    _validateOptions: function(options) {
      ...
      if (typeof options.fullAPI && options.enableRedaction && !(typeof options.fullAPI && options.fullAPI)) {
        console.warn('FullAPI must be enabled for redaction tools to work');
      }
    },
